// Part two is really hard

const code = `shrzvdcghblt21
...
for (i = 0; i < myArray.length; i++) {
  for (const number in mappingWordToNumber) {
    myArray[i] = myArray[i].replaceAll(number, mappingWordToNumber[number])
}
const numbers = myArray[i].match(/\d/g)
